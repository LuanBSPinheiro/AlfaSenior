...
fun PhoneScreen(navController: NavController, context: Context) {
    ...
    val steps = listOf(
        stringResource(R.string.first_step_phone),
        stringResource(R.string.second_step_phone),
        stringResource(R.string.third_step_phone),
        ...
        Card(
            ...
            Column(
                ...
                Icon(
                    ...
                    contentDescription = stringResource(R.string.cellphone),
